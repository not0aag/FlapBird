...
const audioFileMap = {
  ...
  "ा": "matra_aa", "ि": "matra_i", "ी": "matra_ii", "ु": "matra_u", "ू": "matra_uu", "े": "matra_e",
  "ै": "matra_ai", "ो": "matra_o", "ौ": "matra_au", "्": "halant"
};
  ...
  try {
    if (word) {
      ...
      if (["ा", "ि", "ी", "ु", "ू", "े", "ै", "ो", "ौ", "्"].includes(char)) {
        audioPath = path.join(__dirname, 'public', 'audiofiles', 'combinedwords', 'consonants', audioFileName);
      } else {
